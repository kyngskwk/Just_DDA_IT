  ...
  <div>
    ...
    <form class="create-form">
      <div class="form-group">
        ...
        <input type="text" class="form-control roomTitle" id="roomTitle" v-model="roomTitle" required>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control testDate" id="testDate" v-model="testDate" required>
      ...
      <div class="form-group">
        ...
        <input type="password" class="form-control roomPassword" id="roomPassword" v-model="roomPassword">
